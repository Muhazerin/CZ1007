...
// personal use function prototype
void printMenu();
void performOption1(ListNode **ptrHead, int *size);
...
void printMenu()
{
    ...
    puts("2. Remove node");
    puts("3. Print list");
    puts("4. Split list into even and odd list");
    puts("5. Duplicate and reverse list");
    puts("6. Move largest item to the front");
    puts("7. Concatenate list");
    puts("8. Combine and alternate list");
    puts("\n*********** Doubly-linked List ***********");
    puts("9. Insert node");
    puts("10. Remove node");
    puts("\n******************************************");
...
void performOption1(ListNode **head, int *size)
{
    int index, value;
    ...
    printf("Enter value: ");
    scanf("%d", &value);
    if (insertNode(head, index, value) == 0){
        puts("Node inserted");
        (*size)++;
    }
    else {
        puts("Unable to add node to list");
    }
}
