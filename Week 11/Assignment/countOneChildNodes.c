...
{
    /* add your code here */
    int l, r;   // checker to check whether left/right child exist
    int result; // return the result of deeper nodes (whether they got one child or not)
    ...
    if (node == NULL) { // if tree is empty
        ...
        if (node->left != NULL) {   // this way, I dont have to NULL node in the tree
            l = 1;
        ...
        if (node->right != NULL) {  // this way, I dont have to NULL node in the tree
            r = 1;
